...
console.log(mobiles);
const mobileProductsContainer = document.getElementById('mobileProducts');
...
if (mobiles.length > 0) {
  mobiles.forEach(product => {
    ...
    mobileProductsContainer.appendChild(productDiv);
  ...
  mobileProductsContainer.innerHTML = '<p>No mobile products found.</p>';
}
